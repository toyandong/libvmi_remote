    ...
    for(i=0;i<100;i++)
    {
        ...
        while (1){
            ...
            if (pid >= 0){
                //printf("============================================================================\n");
                //printf("[%5d] %s %d\n", pid, procname, state);
                insert_vm_process(vmi, next_process-tasks_offset, pid, procname,&my_ts_off, dom_id, name);
                insert_vm_file(vmi, next_process-tasks_offset, pid, &my_ts_off, dom_id, name);
                insert_process_create(vmi, next_process-tasks_offset, pid, &my_ts_off, dom_id, name);
